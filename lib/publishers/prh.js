...
async function prhFetch(path, params = {}, timeoutMs = 10000) {
...
export async function fetchCategories() {
  return [
    { catId: 1,  description: "Children's Books",       catUri: '/childrens-books',          parentId: null },
    { catId: 2,  description: 'Education',               catUri: '/education',                 parentId: null },
    { catId: 3,  description: 'Young Adult Nonfiction',  catUri: '/young-adult-nonfiction',    parentId: null },
    { catId: 4,  description: 'Nonfiction',              catUri: '/nonfiction',                parentId: null },
    { catId: 5,  description: 'Picture Books',           catUri: '/picture-books',             parentId: null },
    { catId: 6,  description: 'Middle Grade',            catUri: '/middle-grade',              parentId: null },
    { catId: 7,  description: 'Young Adult Fiction',     catUri: '/young-adult-fiction',       parentId: null },
    { catId: 8,  description: 'Art',                     catUri: '/art',                       parentId: null },
    { catId: 9,  description: 'Biography & Autobiography', catUri: '/biography-autobiography',   parentId: null },
    { catId: 10, description: 'Science',                 catUri: '/science',                   parentId: null },
  ];
}
